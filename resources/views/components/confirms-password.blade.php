    ...
    <x-dialog-modal wire:model.live="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4" x-data="{}"
                ...
                <x-ui-password label="Password" autocomplete="current-password" x-ref="confirmable_password"
                    wire:model="confirmablePassword" wire:keydown.enter="confirmPassword" id="confirmablePassword" />
